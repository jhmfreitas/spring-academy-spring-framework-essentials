...
public class AccountControllerTests {
  ...
  @Test
  @WithMockUser(roles = {"USER"})
  public void accountDetailsFail_test_with_USER_role_should_proceed_successfully()
      throws Exception {
  ...
  @Test
  @WithMockUser(roles = {"SUPERADMIN"})
  public void removeBeneficiaryFail_test_with_SUPERADMIN_role_should_proceed_successfully()
      throws Exception {
    Account account = new Account("1234567890", "John Doe");
    given(accountManager.getAccount(0L)).willReturn(account);
