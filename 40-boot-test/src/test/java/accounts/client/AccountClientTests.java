...
//  private static final String BASE_URL = "http://localhost:8080";
  ...
  public void listAccounts() {
    ...
    assertThat(accounts[0].getBeneficiary("Annabelle").getAllocationPercentage()).isEqualTo(
  ...
  public void getAccount() {
    ...
    assertThat(account.getBeneficiary("Annabelle").getAllocationPercentage()).isEqualTo(
        Percentage.valueOf("50%"));
  }
  ...
  public void addAndDeleteBeneficiary() {
    ...
    Beneficiary newBeneficiary = restTemplate.getForObject(newBeneficiaryLocation,
        Beneficiary.class);
    assertThat(newBeneficiary.getName()).isEqualTo("David");

    restTemplate.delete(newBeneficiaryLocation);

    ResponseEntity<Beneficiary> entity = restTemplate.getForEntity(newBeneficiaryLocation,
        Beneficiary.class);
