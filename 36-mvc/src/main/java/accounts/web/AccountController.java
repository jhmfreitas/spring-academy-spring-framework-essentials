 ...
 * <p>
 * Note that some of the Account related classes are imported from the rewards-db project:
 * <p>
 * -Domain objects: Account and Beneficiary -Service layer: AccountManager interface -Repository
 * layer: AccountRepository interface
 */
...
public class AccountController {
  ...
  public Account accountDetails(@PathVariable(name = "accountId") Long accountId) {
