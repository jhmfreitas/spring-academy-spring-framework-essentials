...
public class AccountClientTests {
  ...
  public void listAccounts() {
    ...
    Account[] accounts = restTemplate.getForObject(BASE_URL + "/accounts",
        Account[].class); // Modify this line to use the restTemplate
  ...
  public void getAccount() {
    ...
    // - Run the test and ensure that it passes.
    Account account = restTemplate.getForObject(BASE_URL + "/accounts/{id}", Account.class,
        0); // Modify this line to use the restTemplate
  ...
  public void createAccount() {
    ...
    URI newAccountLocation = restTemplate.postForLocation(BASE_URL + "/accounts",
        account); // Modify this line to use the restTemplate
    ...
    Account retrievedAccount = restTemplate.getForObject(newAccountLocation,
        Account.class); // Modify this line to use the restTemplate
  ...
  public void addAndDeleteBeneficiary() {
    ...
    URI uri = restTemplate.postForLocation(BASE_URL + "/accounts/{accountId}/beneficiaries",
        "David", 1);
    // TODO-14: Retrieve the Beneficiary you just created from the location that was returned
    Beneficiary newBeneficiary = restTemplate.getForObject(uri,
        Beneficiary.class); // Modify this line to use the restTemplate
