...
/**
 * Restaurants calculate how much benefit may be awarded to an account for dining based on a
...
public class Restaurant {
   ...
   * column. This is a database specific accessor using the JPA 2 @Access annotation.
   */
