 ...
 * <p>
 * Stubs facilitate unit testing. An object needing an AccountRepository can work with this stub and
 * not have to bring in expensive and/or complex dependencies such as a Database. Simple unit tests
 * can then verify object behavior by considering the state of this stub.
 */
