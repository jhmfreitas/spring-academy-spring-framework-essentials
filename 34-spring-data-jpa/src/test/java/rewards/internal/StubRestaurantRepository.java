...
/**
 * A dummy restaurant repository implementation. Has a single restaurant "Apple Bees" with a 8%
 * benefit availability percentage that's always available.
 * <p>
 * Stubs facilitate unit testing. An object needing a RestaurantRepository can work with this stub
...
public class StubRestaurantRepository implements RestaurantRepository {
   ...
   * testing--a real availability policy might consider many factors such as the day of week of the
