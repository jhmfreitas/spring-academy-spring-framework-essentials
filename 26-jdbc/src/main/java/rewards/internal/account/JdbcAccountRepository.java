...
public class JdbcAccountRepository implements AccountRepository {
  ...
  public void updateBeneficiaries(Account account) {
    ...
    account.getBeneficiaries().forEach(
        b -> jdbcTemplate.update(sql, b.getSavings().asBigDecimal(), account.getEntityId(),
            b.getName()));
  }
  ...
  private Beneficiary mapBeneficiary(ResultSet rs) throws SQLException {
    ...
    Percentage allocationPercentage = Percentage.valueOf(
        rs.getString("BENEFICIARY_ALLOCATION_PERCENTAGE"));
